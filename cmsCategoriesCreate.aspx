<%@ Page Language="C#"  MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="cmsCategoriesCreate.aspx.cs" Inherits="OnlineShopping.cmsCategoriesCreate" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                           ...
                           <form action="cmsCategoriesCreate.aspx" runat="server" method="post" id = "CreateBrandformValidation">
                               ...
                               <asp:Button ID="CreateBrand" class="btn btn-success" runat="server" Text="Submit" OnClick="CreateCategory_Click"></asp:Button>
